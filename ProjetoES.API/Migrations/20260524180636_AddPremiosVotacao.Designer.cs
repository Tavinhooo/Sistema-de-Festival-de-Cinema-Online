...
namespace ProjetoES.API.Migrations
{
    ...
    [Migration("20260524180636_AddPremiosVotacao")]
    partial class AddPremiosVotacao
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjetoES.API.Models.Premio", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTime?>("DataLimiteVotacao")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("ProjetoES.API.Models.VotoPremio", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("PremioId", "ClienteId")
                        .IsUnique();

                    b.ToTable("VotosPremio");
                });
            ...
            modelBuilder.Entity("ProjetoES.API.Models.VotoPremio", b =>
                {
                    ...
                    b.HasOne("ProjetoES.API.Models.Premio", "Premio")
                        .WithMany("Votos")
